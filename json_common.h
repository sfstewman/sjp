...
enum JSON_RESULT {
  JSON_INTERNAL_ERROR   = -128, // internal error occured

  JSON_TOO_MUCH_NESTING = -10,  // invalid character encountered
  JSON_INVALID_KEY      = -9,   // invalid character encountered

  JSON_UNCLOSED_ARRAY   = -8,   // array is unclosed at the end of input
  JSON_UNCLOSED_OBJECT  = -7,   // array is unclosed at the end of input
  JSON_INVALID_PARAMS   = -6,   // invalid parameters
  ...
  JSON_UNFINISHED_INPUT = -1,   // unfinished input (after end-of-stream stream)
